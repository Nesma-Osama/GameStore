...
exports.isCreatorExistWhenInsert=async(req,res,next)=>{
const{Email}=req.body
const sql=`select *from creator where Email='${Email}'`
...
res.send('Image must be less than or equal 200 letter')
else if(Description>200)
res.send('Description must be less than or equal 200 letter')
else
next()
}
